...
func (o *PostItemTakenURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on PostItemTakenURL")
	}
	...
	if itemID != "" {
		...
		return nil, errors.New("itemId is required on PostItemTakenURL")
	}
...
func (o *PostItemTakenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on PostItemTakenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on PostItemTakenURL")
	}
