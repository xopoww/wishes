...
func NewPostListItemsParams() PostListItemsParams {
	...
	return PostListItemsParams{}
}

// PostListItemsParams contains all the bound params for the post list items operation
...
func (o *PostListItemsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body PostListItemsBody
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			res = append(res, errors.NewParseError("items", "body", "", err))
		} else {
...
func (o *PostListItemsParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
