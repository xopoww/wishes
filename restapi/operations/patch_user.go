...
func (o *PatchUserBody) validateInfo(formats strfmt.Registry) error {
	...
	if o.Info != nil {
		if err := o.Info.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("user" + "." + "info")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("user" + "." + "info")
			}
			return err
		}
	}
...
func (o *PatchUserBody) validateUsername(formats strfmt.Registry) error {
	...
	if o.Username != nil {
		if err := o.Username.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("user" + "." + "username")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("user" + "." + "username")
			}
			return err
		}
	}
...
func (o *PatchUserBody) contextValidateInfo(ctx context.Context, formats strfmt.Registry) error {
...
func (o *PatchUserBody) contextValidateUsername(ctx context.Context, formats strfmt.Registry) error {
